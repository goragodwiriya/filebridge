...
```
index.php        โครงหน้าเว็บ ฝัง SVG sprite ไว้ในตัว
...
| `F3` | เปิดดู (รูป หรือ ตัวแก้ไขข้อความ) | `F4` | แก้ไขเป็นข้อความ |
| `Ctrl` + `A` | เลือกทั้งหมด | `Ctrl` + `R` | โหลดใหม่ |
| `Ctrl` + `F` | ไปที่ช่องกรอง | `Ctrl` + `D` | ดาวน์โหลด |
| `Ctrl` + `H` | สลับแสดงไฟล์ซ่อน | `?` | ดูคีย์ลัดทั้งหมด |

ในหน้าต่างดูรูป: `←` `→` เปลี่ยนรูป · `+` `−` หรือ `Ctrl` + ล้อเมาส์ ซูม · `0` ขนาดจริง ·
`F` พอดีหน้าต่าง · ลากเพื่อเลื่อนภาพเมื่อซูมอยู่ · ดับเบิลคลิกสลับพอดีหน้าต่าง/ขนาดจริง
