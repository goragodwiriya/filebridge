...
| `chunk_size` | ขนาดข้อมูลต่อรอบระหว่างถ่ายโอน |
...
- ลายนิ้วมือ SSH ถูกจำไว้ตั้งแต่การเชื่อมต่อครั้งแรก ถ้าเปลี่ยนไปจะตัดการเชื่อมต่อ
  ทันทีพร้อมแจ้งเตือน
- การลบ เปลี่ยนชื่อ แก้สิทธิ์ อัปโหลด ดาวน์โหลด และถ่ายโอน ถูกบันทึกลง
...
| `Enter` | เปิดโฟลเดอร์ / แก้ไขไฟล์ | `F6` | ย้ายไปอีกแผง |
